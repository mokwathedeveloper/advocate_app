// Simple Notification Service Tests for LegalPro v1.0.1
...
describe('Notification System - Core Functionality', () => {
  ...
  describe('Template Cache Management', () => {
    test('should clear template cache', () => {
      // Mock the clearCache function
      templateEngine.clearCache = jest.fn();
      
      templateEngine.clearCache();
      
      expect(templateEngine.clearCache).toHaveBeenCalled();
    });

    test('should get available templates', async () => {
      templateEngine.getAvailableTemplates = jest.fn().mockResolvedValue({
